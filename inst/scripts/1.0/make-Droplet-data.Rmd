---
title: "Preparing mouse ageing thymus Droplet-seq data for ExperimentHub"
output:
...
meta.data <- meta.data[intersect(colnames(thymus.counts), meta.data$Sample), ]
head(meta.data)
```
...
We are now in the position to save all of these data. We'll do this by breaking up the `SingleCellExperiment` object into smaller, sample-wise 
